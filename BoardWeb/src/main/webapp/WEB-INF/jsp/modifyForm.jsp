...
<form action="modifyBoard.do" method="post">
  ...
  <tr>
		...
		<tr>
			<th>내용</th><td colspan="3"><textarea cols="45" rows="4" class="form-control" readonly></textarea><input type ="text" name="content" value="<%=board.getContent() %>"></td>
		</tr>
		<tr>
			<th>작성자</th><td colspan="3"><input type ="text" name="writer" value="<%=board.getWriter() %>"></td>
		</tr>
		<tr>
